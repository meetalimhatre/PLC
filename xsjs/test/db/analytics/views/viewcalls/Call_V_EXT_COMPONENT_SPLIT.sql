CALL SYS.EXECUTE_MDS_DEV(METHOD=>'Analytics', SCHEMA_NAME=>'_SYS_BIC', PACKAGE_NAME=>'sap.plc.analytics.views', OBJECT_NAME=>'V_EXT_COMPONENT_SPLIT', DATASOURCE_TYPE=>'OLAP', REQUEST=>'{
  "Analytics": {
    "Capabilities": [
      "SP9",
    ...
    "DataSource": {
      "InstanceId": "58FE57A2E64A138FE10000000A618EE9",
      "ObjectName": "V_EXT_COMPONENT_SPLIT",
