...
async function adaptActivityPriceExt(sCurrentSchemaName) {
...
async function insertUniqueActivityPrice(sCurrentSchemaName) {
...
async function insertDuplicatesActivityPrice(sCurrentSchemaName) {
...
export default {iTableThreshold,plcSchema,oSqlccConnection,sXSCTableName,sXSATableName,sXSAExtTableName,sXSCExtTableName,sMetadataTableName,removeOldVersionData,checkTableSize,insertByChuncks,adaptActivityPriceExt,insertUniqueActivityPrice,insertDuplicatesActivityPrice,migrateActivityPrice};
