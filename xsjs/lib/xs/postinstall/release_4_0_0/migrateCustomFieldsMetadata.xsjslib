...
function migrateCustomFieldsMetadataTable () {
...
function migrateCustomFieldsMetadataAttributesTable () {
 ...
 */
function migrateMetadataCustomFields (sSchema, oConnection) {
    sCurrentSchema = sSchema;
    oSqlccConnection = oConnection;
    console.log(sMetadataTable);
    migrateCustomFieldsMetadataTable();
    console.log(sMetadataAttributesTable);
    migrateCustomFieldsMetadataAttributesTable();
