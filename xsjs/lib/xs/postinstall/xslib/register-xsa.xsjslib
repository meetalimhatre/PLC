...
var aPreDatabaseSetUpUpgradeSteps = [
    {
        ...
        version_patch: 0,
        library: [
            "xs.postinstall.release_4_0_0.removeTotalQuantityfromVariant",
        ]
    },
    {
        version: 4,
...
var aPostDatabaseSetupUpgradeSteps = [
    ...
    },
    {
        ...
        version_patch: 0,
        library: [
            "xs.postinstall.release_4_2_0.addMetadataAttributesCustomFieldsRollupCurrency"
        ]
    },
    {
        version: 4,
    ...
    },
    {
        ...
        version_patch: 2,
        library: [
            "xs.postinstall.release_4_3_0.updateLayoutType"
        ]
    },
    {
        version: 4,
    ...
    },
    {
        ...
        version_patch: 5,
        library: [
            "xs.postinstall.release_4_5_0.setActiveLanguageId"
        ]
    },
    {
        version: 4,
...
var aPreDatabaseSetupInstallSteps = [
...
var aOptionalInstallSteps = [
    {
        ...
        library: [
            "xs.postinstall.release_independent.110_ERP_PriceSources"
        ]
    },
    {
        id: 2,
        ...
        library: [
            "xs.postinstall.release_independent.050_ExampleContent"
        ]
    }
];
...
var aOptionalUpgradeSteps = [
    {
        ...
        library: [
            "xs.postinstall.release_4_0_0.instanceBasedUsers"
        ]
    }
];
