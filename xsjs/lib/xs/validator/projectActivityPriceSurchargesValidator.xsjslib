...
function ProjectActivityPriceSurchargesValidator(oPersistency, utils) {
	...
	const aSurchargeMandatoryProperties = [ "PLANT_ID", "ACCOUNT_GROUP_ID", "COST_CENTER_ID", "ACTIVITY_TYPE_ID", "PERIOD_VALUES" ];
	const aSurchargeValidProperties = [ "PLANT_ID", "PLANT_DESCRIPTION", "ACCOUNT_GROUP_ID", "ACCOUNT_GROUP_DESCRIPTION", "COST_CENTER_ID", "COST_CENTER_DESCRIPTION", 
										"ACTIVITY_TYPE_ID", "ACTIVITY_TYPE_DESCRIPTION", "PERIOD_VALUES" ];
	...
	this.validate = function(oRequest, mValidatedParameters) {
		function validateUpdateRequest() {
			...
			_.each(aProjectActivityPriceSurcharges, function(oProjectSurcharges) {
				utils.checkArrayProperties(oProjectSurcharges, aSurchargeMandatoryProperties, aSurchargeValidProperties, 
						{
							...
							COST_CENTER_ID: 	["String", "length=10;", true],
							ACTIVITY_TYPE_ID:	["String", "length=12;", true],
						});
			...
			let aPropertiesToBeChecked = ['PLANT_ID', 'ACCOUNT_GROUP_ID', 'COST_CENTER_ID', 'ACTIVITY_TYPE_ID'];
