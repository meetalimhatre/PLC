    ...
    this.validate = async function (oRequest, mValidatedParameters) {
        ...
        async function validatePostPutRequest() {
            ...
            aBody.forEach(oRetentionPeriod => {
                ...
                if (oRetentionPeriod.VALID_TO && oRetentionPeriod.VALID_FOR || !oRetentionPeriod.VALID_TO && !oRetentionPeriod.VALID_FOR) {
...
export default {helpers,_,constants,ServiceParameters,GenericSyntaxValidator,BusinessObjectTypes,MessageLibrary,Code,MessageDetails,PlcException,aMandatoryProperties,aValidProperties,aValidEntities,RetentionPeriodsValidator};
