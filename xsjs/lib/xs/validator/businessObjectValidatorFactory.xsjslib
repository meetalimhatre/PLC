...
var BusinessObjectValidatorFactory = Object.freeze({
    ...
    /**
     * Creates a new instance of a BusinessObjectValidator. The exact type of the validator is determined by the given
    * business object type.
    *
    * @param {xs.util.constants.BusinessObjectType}
    *            sObjectType - the business object type for which a BusinessObjectValidator instance shall be created
    *
    * @returns {object} the BusinessObjectValidator instance
    */
    createBusinessObjectValidator(sObjectType, oPersistency, sSessionId) {
        ...
        switch (sObjectType) {
            ...
            case BusinessObjectTypes.Item:
                ...
                // TODO (RF): currently the validation for master and configuration data is part of the business logic; the
                // dummy validator just tries to parse to JSON an returns this object for the further processing; it's a
                // story planned to move the validation logic to an appropriate validator class (probably after 1.0)
