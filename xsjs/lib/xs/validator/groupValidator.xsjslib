        ...
        function checkPropertiesValues(oEntity) {
            ...
            Object.keys(oGroup).forEach(key => {
                ...
                if (aPropertyMetadata[0]) {
                     genericSyntaxValidator.validateValue(oGroup[key], aPropertyMetadata[0].SEMANTIC_DATA_TYPE, aPropertyMetadata[0].SEMANTIC_DATA_TYPE_ATTRIBUTES, false, aPropertyMetadata[0].VALIDATION_REGEX_VALUE);
                }
            });
        }
