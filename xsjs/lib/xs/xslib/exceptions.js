 ...
 * @constructor
 */
function DatabaseException(sMessage) {
...
function InvalidRequestException(sMessage, iErrorCode) {
    ExceptionBase.call(this);
    this.name = "InvalidRequestException";
    this.message = sMessage;
    this.errorCode = iErrorCode ? iErrorCode : 400;//$.net.http.BAD_REQUEST;
}
...
function InternalException(sMessage){
    ExceptionBase.call(this);
