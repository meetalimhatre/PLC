 ...
 */
async function getAuthorizationToken(serviceCredentials) {
...
async function createJob(authToken, jobSchedulerUrl, jobOptions) {
    return axios({
        method: 'POST',
...
async function updateJobByName(authToken, jobSchedulerUrl, jobOptions) {
    return axios({
        method: 'PUT',
...
export default {axios,btoa,getAuthorizationToken,createJob,updateJobByName};
