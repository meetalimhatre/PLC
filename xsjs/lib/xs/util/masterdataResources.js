var MasterdataResource = Object.freeze({
    ...
    "Account": {
        ...
        configuration:{
        	aKeyColumns             : ["ACCOUNT_ID","CONTROLLING_AREA_ID"],
        	aTextColumns            : ["ACCOUNT_DESCRIPTION"],
    		aKeyErpTableColumns     : ["KSTAR","KOKRS"],
    		oMappingMainErpPlc      : {"KSTAR":"ACCOUNT_ID",
    			                       "KOKRS":"CONTROLLING_AREA_ID"},
    		oMappingTextErpPlc      : {"KSTAR":"ACCOUNT_ID",
    			                       "KOKRS":"CONTROLLING_AREA_ID",
        	...
        	UsedInBusinessObjects	: [{
										 ...
										 "FieldsName": [ ["ACCOUNT_ID", "CONTROLLING_AREA_ID"] ]
									  },{
    ...
    "Activity_Price": {
        ...
        configuration:{
        	...
        	aOtherMandatoryColumns  : ["TRANSACTION_CURRENCY_ID", "PRICE_UNIT_UOM_ID", "PRICE_SOURCE_ID", "CONTROLLING_AREA_ID", "COST_CENTER_ID", "ACTIVITY_TYPE_ID", "PROJECT_ID", "VALID_FROM", "CUSTOMER_ID", "VALID_FROM_QUANTITY"],
        	IsVersioned             : true,
		    ReferencedObjects: 		  [{
						        		"BusinessObjectName": "Controlling_Area",
						        		"FieldsName":[["CONTROLLING_AREA_ID"]]
		    						  },
		    						  {
						        		...
						        		"FieldsName":[["COST_CENTER_ID","CONTROLLING_AREA_ID"]]
			    					  },
			    					  {
						        		"BusinessObjectName": "Activity_Type",
						        		"FieldsName":[["ACTIVITY_TYPE_ID","CONTROLLING_AREA_ID"]]
				    			      },
				    			      {
    ...
    "Activity_Type": {
        ...
        configuration:{
        	aKeyColumns             : ["ACTIVITY_TYPE_ID", "CONTROLLING_AREA_ID"],
        	aTextColumns            : ["ACTIVITY_TYPE_DESCRIPTION"],
    		aKeyErpTableColumns     : ["LSTAR","KOKRS"],
    		oMappingMainErpPlc      : {"LSTAR":"ACTIVITY_TYPE_ID",
    								   "KOKRS":"CONTROLLING_AREA_ID",
    								   "VKSTA":"ACCOUNT_ID"},
    		oMappingTextErpPlc      : {"LSTAR":"ACTIVITY_TYPE_ID",
    								   "KOKRS":"CONTROLLING_AREA_ID",
        	...
        	UsedInBusinessObjects	: [{
									 ...
									 // The check for Project_ActivityPriceSurcharges is done in .validateAfter(), since it requires resolving of CONTROLLING_AREA_ID over respective project
									  ],
		    ReferencedObjects       : [{
						        		"BusinessObjectName": "Controlling_Area",
						        		"FieldsName":[["CONTROLLING_AREA_ID"]]
    ...
    "Business_Area": {
        ...
        configuration:{
    		...
    		oMappingTextErpPlc      : {"GSBER":"BUSINESS_AREA_ID",
    ...
    "Process": {
        ...
        configuration:{
           	aKeyColumns             : ["PROCESS_ID", "CONTROLLING_AREA_ID"],
           	aTextColumns            : ["PROCESS_DESCRIPTION"],
			aKeyErpTableColumns     : ["PRZNR", "KOKRS"],
			oMappingMainErpPlc      : {"PRZNR":"PROCESS_ID",
							           "KOKRS":"CONTROLLING_AREA_ID"},
			oMappingTextErpPlc      : {"PRZNR":"PROCESS_ID",
									   "KOKRS":"CONTROLLING_AREA_ID",
			...
			UsedInBusinessObjects   : [{
							        	 ...
							        	 "FieldsName": [ ["PROCESS_ID", "CONTROLLING_AREA_ID"]]
							         }]				
            }
    },
    ...
    "Company_Code": {
        ...
        configuration:{
    		...
    		oMappingMainErpPlc      : {"BUKRS":"COMPANY_CODE_ID",
    						           "KOKRS":"CONTROLLING_AREA_ID",
    						           "WAERS":"COMPANY_CODE_CURRENCY_ID"},
            oMappingTextErpPlc      : {"BUKRS":"COMPANY_CODE_ID",
	...
	"Controlling_Area": {
        ...
        configuration:{
        	...
        	oMappingMainErpPlc      : {"KOKRS":"CONTROLLING_AREA_ID",
        					           "WAERS":"CONTROLLING_AREA_CURRENCY_ID"},
            oMappingTextErpPlc      : {"KOKRS":"CONTROLLING_AREA_ID",
    ...
    "Cost_Center": {
        ...
        configuration:{
        	aKeyColumns             : ["COST_CENTER_ID","CONTROLLING_AREA_ID"],
        	aTextColumns            : ["COST_CENTER_DESCRIPTION"],
    		aKeyErpTableColumns     : ["KOSTL","KOKRS"],
    		oMappingMainErpPlc      : {"KOSTL":"COST_CENTER_ID",
    				                   "KOKRS":"CONTROLLING_AREA_ID"},
            oMappingTextErpPlc      : {"KOSTL":"COST_CENTER_ID",
    				                   "KOKRS":"CONTROLLING_AREA_ID",
    ...
    "Costing_Sheet": {
        ...
        configuration:{
        	...
        	aTextColumns            : ["COSTING_SHEET_DESCRIPTION","TOTAL_COST2_DESCRIPTION","TOTAL_COST3_DESCRIPTION"],
    ...
    "Costing_Sheet_Row": {
        ...
        configuration:{
        	aKeyColumns             : ["COSTING_SHEET_ID","COSTING_SHEET_ROW_TYPE","COSTING_SHEET_BASE_ID","CALCULATION_ORDER"],
    ...
    "Currency": {
        ...
        configuration:{
        	...
        	aTextColumns            : ["CURRENCY_CODE", "CURRENCY_DESCRIPTION"],
        	...
        	UsedInBusinessObjects	: [{
										...
										"FieldsName": [ ["COMPANY_CODE_CURRENCY_ID"] ]
										 ...
										 "FieldsName": [ ["FROM_CURRENCY_ID"], ["TO_CURRENCY_ID"] ]
									 },{
										 "BusinessObjectName": "Project",
										 "TableName": "sap.plc.db::basis.t_project",
										 "FieldsName": [ ["SALES_PRICE_CURRENCY_ID"], ["REPORT_CURRENCY_ID"] ],
										 "IsVersioned": false
									 },{
										 ...
										 "FieldsName": [ ["TRANSACTION_CURRENCY_ID"], ["TARGET_COST_CURRENCY_ID"] ],
										 "IsVersioned": false
									 },{
										 "BusinessObjectName": "Item",
    ...
    "Currency_Conversion": {
        ...
        configuration:{
        	aKeyColumns             : ["EXCHANGE_RATE_TYPE_ID","FROM_CURRENCY_ID", "TO_CURRENCY_ID", "VALID_FROM"],
        	aKeyErpTableColumns     : ["FCURR","TCURR","ERP_DATE"],
			oMappingMainErpPlc      : {"FCURR":"FROM_CURRENCY_ID",
    ...
    "Customer": {
        ...
        configuration:{
			...
			oMappingMainErpPlc      : {"KUNNR":"CUSTOMER_ID",
							           "NAME1":"CUSTOMER_NAME",
							           "LAND1":"COUNTRY",
							           "PSTLZ":"POSTAL_CODE",
                            		   "REGIO":"REGION",
    ...
    "Document": {
        ...
        configuration:{
        	aKeyColumns             : ["DOCUMENT_TYPE_ID", "DOCUMENT_ID", "DOCUMENT_VERSION", "DOCUMENT_PART"],
        	aTextColumns            : ["DOCUMENT_DESCRIPTION"],
        	aKeyErpTableColumns     : ["DOKAR","DOKNR", "DOKVR", "DOKTL"],
			...
			oMappingTextErpPlc      : {"DOKAR": "DOCUMENT_TYPE_ID",
				  					   "DOKNR":"DOCUMENT_ID",
				  					   "DOKVR": "DOCUMENT_VERSION",
				  					   "DOKTL": "DOCUMENT_PART",
	        ...
	        ReferencedObjects:      [{
						        		...
						        		"FieldsName":[["DOCUMENT_TYPE_ID","DOCUMENT_STATUS_ID"]]
					                }]            
         }
	},
	...
	"Document_Status": {
        ...
        configuration:{
        	aKeyColumns             : ["DOCUMENT_TYPE_ID", "DOCUMENT_STATUS_ID"],
        	aTextColumns            : ["DOCUMENT_STATUS_DESCRIPTION"],
        	aKeyErpTableColumns     : ["DOKAR","DOKST"],
			oMappingMainErpPlc      : {"DOKAR":"DOCUMENT_TYPE_ID",
				                       "DOKST":"DOCUMENT_STATUS_ID"},
			oMappingTextErpPlc      : {"DOKST":"DOCUMENT_STATUS_ID",
    ...
    "Material_Account_Determination": {
        ...
        configuration:{
        	aKeyColumns             : ["CONTROLLING_AREA_ID", "MATERIAL_TYPE_ID", "PLANT_ID", "VALUATION_CLASS_ID"],
        	aOtherMandatoryColumns  : ["ACCOUNT_ID"],
    		aKeyErpTableColumns		: ["KOKRS", "MTART" , "WERKS", "BKLAS"],
    		oMappingMainErpPlc      : {"KOKRS":"CONTROLLING_AREA_ID",
    								   "MTART":"MATERIAL_TYPE_ID",
    								   "WERKS":"PLANT_ID",
    ...
    "Material_Group": {
        ...
        configuration:{
    		...
    		oMappingTextErpPlc      : {"MATKL":"MATERIAL_GROUP_ID",
    ...
    "Material_Type": {
        ...
        configuration:{
    		...
    		oMappingTextErpPlc      : {"MTART":"MATERIAL_TYPE_ID",
    ...
    "Material_Plant": {
        ...
        configuration:{
        	aKeyColumns             : ["MATERIAL_ID", "PLANT_ID"],
        	aKeyErpTableColumns     : ["MATNR", "WERKS"],
    		oMappingMainErpPlc      : {"MATNR":"MATERIAL_ID",
    								   "WERKS":"PLANT_ID",
        	...
        	ReferencedObjects       : [{ 
						        		...
						        		"FieldsName":[["OVERHEAD_GROUP_ID","PLANT_ID"]]
						              },{
						        		"BusinessObjectName": "Valuation_Class",
						        		"FieldsName":[["VALUATION_CLASS_ID"]]
						              },{
    ...
    "Material_Price": {
        ...
        configuration:{
        	aKeyColumns             : ["PRICE_ID"],
        	aOtherMandatoryColumns  : ["TRANSACTION_CURRENCY_ID", "PRICE_UNIT_UOM_ID", "PRICE_SOURCE_ID", "MATERIAL_ID", "PLANT_ID", "VENDOR_ID", "PROJECT_ID", "VALID_FROM", "VALID_FROM_QUANTITY", "CUSTOMER_ID"],
        	aKeyErpTableColumns		: ["PRICE_SOURCE_ID", "MATNR", "WERKS", "VENDOR_ID", "PROJECT_ID", "VALID_FROM", "VALID_FROM_QUANTITY"],
    		oMappingMainErpPlc      : {"PRICE_SOURCE_ID":"PRICE_SOURCE_ID",
    			                       "MATNR":"MATERIAL_ID", 
    			                       "WERKS":"PLANT_ID",
    			                       "VENDOR_ID":"VENDOR_ID",
    ...
    "Overhead_Group": {
        ...
        configuration:{
        	aKeyColumns             : ["OVERHEAD_GROUP_ID","PLANT_ID"],
        	aTextColumns            : ["OVERHEAD_GROUP_DESCRIPTION"],
        	aKeyErpTableColumns     : ["KOSGR","WERKS"],
    		oMappingMainErpPlc      : {"KOSGR":"OVERHEAD_GROUP_ID",
    								   "WERKS":"PLANT_ID"},
    		oMappingTextErpPlc      : {"KOSGR":"OVERHEAD_GROUP_ID",
    								   "WERKS":"PLANT_ID",
    ...
    "Plant": {
        ...
        configuration:{
    		...
    		oMappingMainErpPlc      : {"WERKS" : "PLANT_ID",
    								   ...
    								   "ORT01" : "CITY",
    								   "STRAS" : "STREET_NUMBER_OR_PO_BOX"},
    		oMappingTextErpPlc      : {"WERKS":"PLANT_ID",
    ...
    "Price_Source": {
        ...
        configuration:{
        	aKeyColumns             : ["PRICE_SOURCE_ID", "PRICE_SOURCE_TYPE_ID"],
    ...
    "Profit_Center": {
        ...
        configuration:{
        	aKeyColumns             : ["PROFIT_CENTER_ID", "CONTROLLING_AREA_ID"],
        	aTextColumns            : ["PROFIT_CENTER_DESCRIPTION"],
        	aKeyErpTableColumns     : ["PRCTR","KOKRS"],
    		oMappingMainErpPlc      : {"PRCTR":"PROFIT_CENTER_ID",
    								   "KOKRS":"CONTROLLING_AREA_ID"},
    		oMappingTextErpPlc      : {"PRCTR":"PROFIT_CENTER_ID",
    								   "KOKRS":"CONTROLLING_AREA_ID",
        	...
        	UsedInBusinessObjects   : [{
										"BusinessObjectName" : "Project",
										"TableName" : "sap.plc.db::basis.t_project",
										"FieldsName" : [ ["PROFIT_CENTER_ID", "CONTROLLING_AREA_ID"] ],
										"IsVersioned": false
						             }],
            ReferencedObjects       : [{
						        		"BusinessObjectName": "Controlling_Area",
    ...
    "Unit_Of_Measure": {
        ...
        configuration:{
        	aKeyColumns             : ["UOM_ID"],
        	aTextColumns            : ["UOM_CODE", "UOM_DESCRIPTION"],
        	aKeyErpTableColumns     : ["MSEHI"],
			oMappingMainErpPlc      : {"MSEHI":"UOM_ID",
									   "DIMID":"DIMENSION_ID",
									   "ZAEHL":"NUMERATOR",
									   "NENNR":"DENOMINATOR",
									   "EXP10":"EXPONENT_BASE10",
                					   "ADDKO":"SI_CONSTANT"},
            oMappingTextErpPlc      : {"LANGU":"LANGUAGE",
            						   "MSEHI":"UOM_ID",
        	...
        	UsedInBusinessObjects   : [{
										...
										"FieldsName": [ ["MATERIAL_LOT_SIZE_UOM_ID"] ]
										 ...
										 "BusinessObjectName": "Item",
										 "TableName": "sap.plc.db::basis.t_item",
										 "FieldsName": [ ["QUANTITY_UOM_ID"], ["TOTAL_QUANTITY_UOM_ID"], ["PRICE_UNIT_UOM_ID"] ],
										 "IsVersioned": false
									 },{
										 "BusinessObjectName": "Item",
										 "TableName": "sap.plc.db::basis.t_item_temporary",
    ...
    "Valuation_Class": {
        ...
        configuration:{
    		...
    		oMappingTextErpPlc      : {"BKLAS":"VALUATION_CLASS_ID",
    ...
    "Vendor": {
        ...
        configuration:{
			...
			oMappingMainErpPlc      : {"LIFNR":"VENDOR_ID",
							           "NAME1":"VENDOR_NAME",
							           "LAND1":"COUNTRY",
							           "PSTL2":"POSTAL_CODE",
			                           "REGIO":"REGION",
    ...
    "Work_Center": {
        ...
        configuration:{
        	aKeyColumns             : ["WORK_CENTER_ID", "PLANT_ID"],
        	aTextColumns            : ["WORK_CENTER_DESCRIPTION"],
        	aOtherMandatoryColumns  : ["COST_CENTER_ID", "CONTROLLING_AREA_ID"],
	...
	"Work_Center_Activity": {
        ...
        configuration:{
        	aKeyColumns             : ["ACTIVITY_TYPE_ID", "WORK_CENTER_ID", "CONTROLLING_AREA_ID", "PLANT_ID", "PROCESS_ID"],
    ...
    "Work_Center_Process": {
        ...
        configuration:{
        	aKeyColumns             : ["PROCESS_ID", "WORK_CENTER_ID", "CONTROLLING_AREA_ID", "PLANT_ID"],
...
var Source = Object.freeze([1, 2]);//1-PLC,2-ERP
...
var aNotMaintainableBusinessObjects = Object.freeze(["Confidence_Level", "Dimension", 
    "Document", "Document_Type", "Document_Status", "Design_Office"]);
