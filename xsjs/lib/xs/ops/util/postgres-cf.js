...
Postgres.prototype.connect = function () {
    async.waterfall.sync([fCallback => {
...
Postgres.prototype.execute = function () {
    const oResult = async.waterfall.sync([fCallback => {
            this.connect();
            this.client.query.apply(this.client, [
                ...arguments,
...
Postgres.prototype.rollback = async function () {
    await this.execute('ROLLBACK');
};

Postgres.prototype.begin = async function () {
...
Postgres.prototype.commit = async function () {
