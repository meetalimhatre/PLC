...
function ConnectionFactory($) {
    ...
    this.getConnection = function () {
        ...
        var connection = $.hdb.getConnection({ "treatDateAsUTC": true, "enableColumnIndices": false });
 ...
 */
module.exports.getContainerSchema = function ($) {
    ...
    if (oPlatform === "XSA-OP") {
        ...
        let connection = $.hdb.getConnection({ "treatDateAsUTC": true, "enableColumnIndices": false });
