...
function RetentionPeriods($, dbConnection) {
	 ...
	 *
	 */
	this.create = function(aRetentionPeriods) {
        let aRetentionPeriodsValues=[];        
        aRetentionPeriods.forEach (oRetentionPeriod => aRetentionPeriodsValues.push([oRetentionPeriod.ENTITY.toUpperCase(), oRetentionPeriod.SUBJECT.toUpperCase(), oRetentionPeriod.VALID_TO, oRetentionPeriod.VALID_FOR]));
		let aInsertResult;
		try {
	 ...
	 *
	 */
	this.deletePeriods = function(aRetentionPeriods) {
        let aRetentionPeriodsValues=[];        
        aRetentionPeriods.forEach (oRetentionPeriod => aRetentionPeriodsValues.push([oRetentionPeriod.ENTITY.toUpperCase(), oRetentionPeriod.SUBJECT.toUpperCase()]));
		let aDeleteResult;
		try {
...
/**
	 ...
	 *
	 */
	this.update = function(aRetentionPeriods) {
        let aRetentionPeriodsValues=[];        
        aRetentionPeriods.forEach (oRetentionPeriod => aRetentionPeriodsValues.push([oRetentionPeriod.VALID_TO, oRetentionPeriod.VALID_FOR, oRetentionPeriod.ENTITY.toUpperCase(), oRetentionPeriod.SUBJECT.toUpperCase()]));
		let aUpdateResult;
		try {
