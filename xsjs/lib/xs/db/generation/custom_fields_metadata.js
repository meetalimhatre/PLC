...
var mDbArtefactsMetadata = {
	...
	"gtt_item_temporary_with_masterdata_custom_fields": {
		...
		"boDependencies": [
			"Material", "Material_Price", "Material_Plant", "Cost_Center", "Work_Center", "Activity_Price"
		],
		"dependencies": []
	},
	...
	"p_calculation_version_trigger_price_determination": {
		...
		"packageName": "db.calculationmanager.procedures",
		"boDependencies": [
			"Item", "Material_Price", "Activity_Price"
		]
	},
	"p_calculate_saved_calculation_version": {
	...
	"p_masterdata_read": {
        ...
        "boDependencies": [
            "Material", "Material_Plant", "Cost_Center"
        ],
    	"dependencies": [
    		"tt_material",
    		"tt_material_plant",
	...
	"p_referenced_calculation_version_data_read": {
		...
		"boDependencies": [
			"Item", "Material", "Material_Plant", "Cost_Center", "Work_Center"
		],
		"dependencies": [
			"ts_item",
			"tt_material",
	...
	"p_item_create": {
		...
		"boDependencies": [
			"Item", "Material", "Material_Price", "Material_Plant", "Cost_Center", "Activity_Price"
		],
		"dependencies": [
			"gtt_item_temporary",
			"gtt_item_temporary_with_masterdata_custom_fields",
    ...
    "p_calculation_version_get_masterdata": {
        ...
        "boDependencies": [
            "Item", "Activity_Price", "Cost_Center", "Material", "Material_Plant", "Work_Center"
        ],
    	"dependencies": [
    	    "tt_work_center",
    		"tt_material",
    ...
    "p_project_read": {
        ...
        "boDependencies": [
            "Material", "Material_Plant", "Cost_Center", "Work_Center"
        ],
    	"dependencies": [
    		"p_masterdata_read"
    	] 
    ...
    "p_item_get_prices": {
        ...
        "boDependencies": [
            "Material", "Cost_Center", "Material_Price", "Item", "Activity_Price"
        ],
    	"dependencies": [
    		"tt_material",
    		"tt_cost_center",
    ...
    "p_item_determine_dependent_fields": {
        ...
        "boDependencies": [
            "Material", "Material_Price", "Material_Plant", "Cost_Center", "Work_Center"
        ],
    	"dependencies": [
    ...
    "p_calculation_version_masterdata_timestamp_update": {
        ...
        "boDependencies": [
            "Material", "Material_Price", "Material_Plant", "Cost_Center"
        ],
    	"dependencies": [
    		"ts_item_temporary_with_masterdata_custom_fields",
    		"gtt_item_temporary_with_masterdata_custom_fields",
    ...
    "tt_material": {
		...
		"boDependencies": [
			"Material", "Material_Plant", "Material_Price"
		],
		"dependencies": []
	},
    "tt_material_plant": {
...
// instance based privileges (hierarchy view and procedure)	    
		...
		"p_unroll_privileges": {
			...
			"boDependencies": [	"Item" ],
			"dependencies": [ "V_GROUP_HIERARCHY", "ts_privilege_object_filter" ]
		},			
		"p_unroll_privileges_on_object_update": {
			"type": "SQLScript",
		...
		"p_data_protection_update_user_ids": {
			...
			"boDependencies": [	"Cost_Center", "Material", "Material_Plant", "Material_Price" ],
			"dependencies": []
		},
		"V_DATA_PROTECTION_DISPLAY_INFO": {
			"type": "SQLView",
