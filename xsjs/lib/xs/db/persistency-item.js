...
async function Item($, dbConnection, hQuery, sUserId) {
	 ...
	 */
    async function executeItemMassUpdate(aItems, sTableName, sSessionId, aUpdateFields) {
	 ...
	 */
    this.setActiveStates = async function (aItems, iCvId, sSessionId) {
        if (aItems.length === 0) {
            return {
                NEW_ITEMS: [],
                UPDATED_ITEMS: [],
	...
	*/
    this.setTotalQuantityOfVariants = async (iCalculationVersionId, iVariantId) => {
	...
	*/
    this.clearTotalQauntityOfVariants = async iCalculationVersionId => {
