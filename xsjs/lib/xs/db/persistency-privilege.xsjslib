...
function Privilege(dbConnection) {
    ...
    this.insertUserPrivileges = async function (aPrivileges, sEntityType, sEntityId) {
        ...
        return await helpers.unsuccessfulItemsDbOperation(aPrivileges, aInsertResult);
    };
    ...
    this.deleteUserPrivileges = async function (aPrivileges, sEntityType, sEntityId) {
        ...
        return await helpers.unsuccessfulItemsDbOperation(aPrivileges, aDeleteResult);
    };
    ...
    this.updateUserPrivileges = async function (aPrivileges, sEntityType, sEntityId) {
        ...
        return await helpers.unsuccessfulItemsDbOperation(aPrivileges, aUpdateResult);
    };
...
Privilege.prototype = await Object.create(Privilege.prototype);
