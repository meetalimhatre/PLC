...
function Document(dbConnection, hQuery, sObjectName) {
	...
	Document.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {};
    	const oFilters = [
    	    ["DOCUMENT_ID", "plcTable.DOCUMENT_ID"],
    	    ["DOCUMENT_TYPE_ID", "plcTable.DOCUMENT_TYPE_ID"],
    	    ["DOCUMENT_VERSION", "plcTable.DOCUMENT_VERSION"],
    	    ["DOCUMENT_PART", "plcTable.DOCUMENT_PART"],
