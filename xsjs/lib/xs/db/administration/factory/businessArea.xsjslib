...
function BusinessArea(dbConnection, hQuery, sObjectName) {
	...
	BusinessArea.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {}; 	
    	
    	var oFilters = [
    	    ["BUSINESS_AREA_ID", "plcTable.BUSINESS_AREA_ID"],
    	    ["BUSINESS_AREA_DESCRIPTION", "plcTextTable.BUSINESS_AREA_DESCRIPTION"],
