...
function Dimension(dbConnection, hQuery, sObjectName) {
	...
	Dimension.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {}; 	
    	var result = fnProcedure(oProcedureParameters.sLanguage, oProcedureParameters.sMasterDataDate, 
    				             oProcedureParameters.sAutocompleteText, oProcedureParameters.iTopRecords,
