...
function ConfidenceLevel(dbConnection, hQuery, oConfiguration) {
	...
	ConfidenceLevel.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {}; 
    	
		var result = fnProcedure(oProcedureParameters.sLanguage, oProcedureParameters.sAutocompleteText, oProcedureParameters.iTopRecords, oProcedureParameters.iSkipRecords );
