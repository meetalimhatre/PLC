...
function DesignOffice(dbConnection, hQuery, sObjectName) {
	...
	DesignOffice.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {};
    	var oFilters = [
    	    ["DESIGN_OFFICE_ID", "plcTable.DESIGN_OFFICE_ID"],
    	    ["DESIGN_OFFICE_DESCRIPTION", "plcTextTable.DESIGN_OFFICE_DESCRIPTION"],
