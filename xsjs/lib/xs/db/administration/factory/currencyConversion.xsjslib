...
function CurrencyConversion(dbConnection, hQuery, sObjectName) {
	...
	CurrencyConversion.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {}; 	
	...
	*/
	CurrencyConversion.prototype.initializeColumns = function(oRecord, sOperation, sObjectType){		
	...
	*/
	CurrencyConversion.prototype.validateAfter = function(){
