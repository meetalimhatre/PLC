...
function DocumentType(dbConnection, hQuery, sObjectName) {
	...
	DocumentType.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	...
    	var oFilters = [
    	    ...
    	    ["DOCUMENT_TYPE_DESCRIPTION", "plcTextTable.DOCUMENT_TYPE_DESCRIPTION"],
...
/**
     ...
     */  
function getDocumentTypeEntities(aDocumentTypeIds, masterdataTimestamp, oProcedureParameters, dbConnection) {
