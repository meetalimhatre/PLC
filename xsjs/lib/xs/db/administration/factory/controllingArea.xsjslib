...
function ControllingArea(dbConnection, hQuery, sObjectName) {
	...
	ControllingArea.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {};
    	
    	var oFilters = [
    	    ["CONTROLLING_AREA_ID", "plcTable.CONTROLLING_AREA_ID"],
    	    ["CONTROLLING_AREA_CURRENCY_ID", "plcTable.CONTROLLING_AREA_CURRENCY_ID"],
    	    ["CONTROLLING_AREA_DESCRIPTION", "plcTextTable.CONTROLLING_AREA_DESCRIPTION"],
...
/**
     ...
     */    
function getControllingAreaEntities(aControllingAreaIds, masterdataTimestamp, sLanguage, dbConnection) {
