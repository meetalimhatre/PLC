...
function Material(dbConnection, hQuery, sObjectName) {
	...
	Material.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {}; 
    	var oFilters = [
    	    ["MATERIAL_ID", "plcTable.MATERIAL_ID"],
    	    ["MATERIAL_DESCRIPTION", "plcTextTable.MATERIAL_DESCRIPTION"],
    	    ["MATERIAL_TYPE_ID", "plcTable.MATERIAL_TYPE_ID"],
    	    ["MATERIAL_GROUP_ID", "plcTable.MATERIAL_GROUP_ID"],
    	    ["BASE_UOM_ID", "plcTable.BASE_UOM_ID"],
    	    ["IS_CREATED_VIA_CAD_INTEGRATION", "plcTable.IS_CREATED_VIA_CAD_INTEGRATION"],
    	    ["IS_PHANTOM_MATERIAL", "plcTable.IS_PHANTOM_MATERIAL"],
    	    ["IS_CONFIGURABLE_MATERIAL", "plcTable.IS_CONFIGURABLE_MATERIAL"],
