...
function Vendor(dbConnection, hQuery, sObjectName) {
	...
	Vendor.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	...
    	var oFilters = [
    	    ["VENDOR_ID", "plcTable.VENDOR_ID"],
    	    ["VENDOR_NAME", "plcTable.VENDOR_NAME"],
