...
function CostCenter(dbConnection, hQuery, sObjectName) {
	...
	CostCenter.prototype.getDataUsingSqlProcedure = function(fnProcedure, oProcedureParameters){
    	var oReturnObject = {}; 
    	
    		var oFilters = [
    	    ["COST_CENTER_ID", "plcTable.COST_CENTER_ID"],
    	    ["COST_CENTER_DESCRIPTION", "plcTextTable.COST_CENTER_DESCRIPTION"],
	...
	CostCenter.prototype.validateAfter = function(){
