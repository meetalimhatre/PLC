...
var Procedures = Object.freeze({
	component_split_read : 'sap.plc.db.administration.procedures::p_component_split_read'
});
...
function ComponentSplit(dbConnection, hQuery, hQueryRepl) {
	...
	var oConfigurationCostEl = {
			...
			aPartialKeyPlcTableColumns : ["ACCOUNT_GROUP_ID", "COMPONENT_SPLIT_ID"]
	};
    ...
    this.remove = function(oBatchItems, sMasterDataDate){
      ...
      */
     this.removeComponentSplitRow = function(oComponentSplit, sMasterDataDate){
    	 var oResult = apiHelpers.removeRow(oComponentSplit,sMasterDataDate,oConfiguration,hQuery);

    	 //delete entries from table t_component_split_account_group
    	 var aGrRecords = apiHelpers.findValidEntriesInTable(Resources[sBusinessObjectNameCostEl].dbobjects.plcTable, [oConfiguration.aPartialKeyPlcTableColumns[0]], [oComponentSplit.COMPONENT_SPLIT_ID], sMasterDataDate, hQuery);
    	 if (aGrRecords.length !== 0){
    		 var iDeletedRecords = apiHelpers.updateEntriesWithValidToInTable(Resources[sBusinessObjectNameCostEl].dbobjects.plcTable, [oConfiguration.aPartialKeyPlcTableColumns[0]], [oComponentSplit.COMPONENT_SPLIT_ID], sMasterDataDate, hQuery);
      ...
      * @returns {object} oResult          - deleted entry
      */
     this.removeAccountGroupsRow = function(oAccountGroup,sMasterDataDate){

    	 return apiHelpers.removeRow(oAccountGroup,sMasterDataDate,oConfigurationCostEl,hQuery);
       ...
       * @returns {object} oResult          - deleted entry
       */
      this.removeComponentSplitTextRow = function(oComponentSplitText,sMasterDataDate){

    	  return apiHelpers.removeTextRow(oComponentSplitText,sMasterDataDate,oConfiguration,hQuery);

      };
      
      this.removeAllAccountGroupsforComponentSplit = function(oComponentSplit, sMasterDataDate){
      ...
      */
      this.insert = function(oBatchItems, sMasterDataDate){
    	  ...
    	  _.each(aBatchAccountGroupsItems, function(oRecord){ 
    		  try {
       ...
       */
      this.insertComponentSplitRow = function(oComponentSplit,sMasterDataDate){

    	  var oResult = apiHelpers.insertRow(oComponentSplit,sMasterDataDate,oConfiguration,hQuery,hQueryRepl,this.helper);
      ...
      this.insertComponentSplitTextRow = function(oComponentSplitText,sMasterDataDate){

    	  return apiHelpers.insertTextRow(oComponentSplitText,sMasterDataDate,oConfiguration,hQuery,this.helper);

      };

      this.insertSelectedAccountGroupsRow = function(oCostElGrCostComp,sMasterDataDate){
    	  ...
    	  var aFoundCostElGroupRecords = apiHelpers.findValidEntriesInTable(Resources[sBusinessObjectNameCostElGroup].dbobjects.plcTable, [oConfigurationCostEl.aPartialKeyPlcTableColumns[0]], [aFieldsValuesMainPlcTable[0]], sMasterDataDate, hQuery);
    	  ...
    	  var aFoundComponentSplitRecords = apiHelpers.findValidEntriesInTable(Resources[sBusinessObjectName].dbobjects.plcTable, [oConfigurationCostEl.aPartialKeyPlcTableColumns[1]], [aFieldsValuesMainPlcTable[1]], sMasterDataDate, hQuery);
    	  ...
    	  return apiHelpers.insertRow(oCostElGrCostComp,sMasterDataDate,oConfigurationCostEl,hQuery,hQueryRepl,this.helper);
      ...
      */
       ...
       */ 
      this.updateComponentSplitTextRow = function(oComponentSplitText,sMasterDataDate){

    	  return apiHelpers.updateTextRow(oComponentSplitText,sMasterDataDate,oConfiguration,hQuery,this.helper);
