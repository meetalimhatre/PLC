...
function CostingSheetRow(dbConnection, hQuery, hQueryRepl) {
	...
	this.remove = function(oBatchItems, sMasterDataDate){
		...
		_.each(aCostingSheetRowBaseRowItems, function(oRecord){ 
			try {
		...
		_.each(aCostingSheetRowBaseItems, function(oRecord){ 
			try {
		...
		_.each(aBatchMainTextItems, function(oRecord){ 
			try {
		...
		_.each(aBatchDependenciesItems, function(oRecord){ 
			try {
	 ...
	 */
	this.removeCostingSheetOverheadRow = function(oCostingSheetOverhead,sMasterDataDate){

		var oConfiguration = {
				sObjectName                : sCostingSheetOverhead,
				aPartialKeyPlcTableColumns : ["COSTING_SHEET_OVERHEAD_ID", "IS_ROLLED_UP"]
		};
		var oResult = [];
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.removeCostingSheetOverheadRowRow = function(oCostingSheetOverheadRow,sMasterDataDate){

		let oConfiguration = {
				sObjectName                : sCostingSheetOverheadRow,
				aPartialKeyPlcTableColumns : ["COSTING_SHEET_OVERHEAD_ROW_ID", "COSTING_SHEET_OVERHEAD_ID"]
		};
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.removeCostingSheetBaseRowRow = function(oCostingSheetBaseRow,sMasterDataDate){

		var oConfiguration = {
				sObjectName                : sCostingSheetBaseRow,
				aPartialKeyPlcTableColumns : ["COSTING_SHEET_BASE_ID", "ITEM_CATEGORY_ID"]
		};
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.removeCostingSheetBaseRow = function(oCostingSheetBase,sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.removeCostingSheetTextRowRow = function(oCostingSheetRowText,sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.removeCostingSheetRowRow = function(oCostingSheetRow,sMasterDataDate){

		var oConfiguration = {
				sObjectName                : sCostingSheetRow,
				aPartialKeyPlcTableColumns : ["COSTING_SHEET_ROW_ID", "COSTING_SHEET_ID"]
		};
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.removeCostingSheetRowDependencies = function(oCostingSheetDependencies,sMasterDataDate){

		var oConfiguration = {
				sObjectName                : sCostingSheetRowDependencies,
				aPartialKeyPlcTableColumns : ["SOURCE_ROW_ID", "TARGET_ROW_ID", "COSTING_SHEET_ID"]
		};
	...
	this.removeAllDependeciesforCostingSheetRow = function(oRecord, sMasterDataDate){
	...
	this.removeDependecyIfExists = function(oRecord, sMasterDataDate){
    	var sTableName     = Resources[sCostingSheetRowDependencies].dbobjects.plcTable;
	 ...
	 */
	this.removeTextIfExists = function(oRecord, sMasterDataDate){
	...
	this.validateFormulaString = function() {
	...
	this.update = function(oBatchItems, sMasterDataDate){    	 
		...
		_.each(aCostingSheetOverheadRowItems, function(oRecord){ 
			try {
				...
				helpers.isNullOrUndefined(oRecord.FORMULA_STRING) &&
				helpers.isNullOrUndefined(oRecord.FORMULA_DESCRIPTION) &&
				helpers.isNullOrUndefined(oRecord.OVERHEAD_CUSTOM)) {
				...
				let oResultUpdate = that.updateCostingSheetOverheadRowRow(_.omit(oRecord, ["FORMULA_STRING", "FORMULA_DESCRIPTION","OVERHEAD_CUSTOM"]), sMasterDataDate);
		...
		oResult.entities[BusinessObjectsEntities.COSTING_SHEET_ROW_DEPENDENCIES_ENTITIES] = [];
		_.each(aBatchDepItems, function(oRecord){ 
			try {
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.updateCostingSheetOverheadRowRow = function(oCostingSheetOverheadRow, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.updateCostingSheetOverheadRow = function(oCostingSheetOverhead, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.updateCostingSheetBaseRowRow = function(oCostingSheetBaseRow, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.updateCostingSheetBaseRow = function(oCostingSheetBase, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.updateCostingSheetRowRow = function(oCostingSheetRow, sMasterDataDate){
		...
		if(!helpers.isNullOrUndefined(oCostingSheetRow.COSTING_SHEET_ROW_TYPE) && oCostingSheetRow.COSTING_SHEET_ROW_TYPE === 1) {//Base as Account Group
		    oConfiguration.aFieldsNotNull.push('ACCOUNT_GROUP_AS_BASE_ID');
		}

		checkIfBaseRowsUpdateReadOnlyFields(oCostingSheetRow);

		//for base rows we automatically set IS_RELEVANT_FOR_TOTAL flags as 1
	...
	/** Helper function to check if the IS_RELEVANT_FOR_TOTAL fields are to be inserted/updated for base row entities.
	 *  This should not be allowed since these fields are read-only
	 * 
	 * @param oCostingSheetRow - row to be checked
	 */
	function checkIfBaseRowsUpdateReadOnlyFields(oCostingSheetRow){
	
		//IS_RELEVANT_FOR_TOTAL is READ_ONLY for costing sheet row base
		...
		if(!helpers.isNullOrUndefined(sCostingSheetRowType) && (sCostingSheetRowType === 1 || sCostingSheetRowType === 2)){
			...
			var aReadOnlyColumnsForBase = ["IS_RELEVANT_FOR_TOTAL", "IS_RELEVANT_FOR_TOTAL2", "IS_RELEVANT_FOR_TOTAL3"];
			...
			if(aInvalidProperties.length){
				...
				$.trace.error(sLogMessage);
				var oMessageDetails = new MessageDetails();
				oMessageDetails.validationObj = {"columnIds": aInvalidColumns, "validationInfoCode": ValidationInfoCode.READONLY_FIELD_ERROR};
	 ...
	 *
	 * @param   {object} oControllingArea - entry that is checked
	 * @param   {string} sMasterDataDate  - master data timestamp
	 */
	 ...
	 * Check if the referenced objects exists; if they do not exist, then create them
	 *
	 * @param   {object} oCostingSheetOverheadRow - entry that is checked
	 * @param   {string} sMasterDataDate  - master data timestamp
	 */
	this.checkReferenceObjectsCostingSheetOverheadRow = function(oCostingSheetOverheadRow, sMasterDataDate) {

		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.CONTROLLING_AREA_ID))&&(oCostingSheetOverheadRow.CONTROLLING_AREA_ID!=="")){
			// check ControllingArea
			const aFieldsMainPlcTable = ["CONTROLLING_AREA_ID"];//name in t_company_code
			const aKeyFieldsRefObjectPlcTable = ["CONTROLLING_AREA_ID"];//name in t_controlling_area  
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.COMPANY_CODE_ID))&&(oCostingSheetOverheadRow.COMPANY_CODE_ID!=="")){
			// check CompanyCode
			const aFieldsMainPlcTable = ["COMPANY_CODE_ID"];//name in t_company_code
			const aKeyFieldsRefObjectPlcTable = ["COMPANY_CODE_ID"];//name in t_plant  
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.BUSINESS_AREA_ID))&&(oCostingSheetOverheadRow.BUSINESS_AREA_ID!=="")){
			// checkBusinessArea
			const aFieldsMainPlcTable = ["BUSINESS_AREA_ID"];//name in t_business_area
			const aKeyFieldsRefObjectPlcTable = ["BUSINESS_AREA_ID"];//name in t_plant  
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.PROFIT_CENTER_ID))&&(oCostingSheetOverheadRow.PROFIT_CENTER_ID!=="")){
			// checkProfitCenter
			const aFieldsMainPlcTable = ["PROFIT_CENTER_ID", "CONTROLLING_AREA_ID"];//name in t_business_area
			const aKeyFieldsRefObjectPlcTable = ["PROFIT_CENTER_ID","CONTROLLING_AREA_ID"];//name in t_plant
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.PLANT_ID))&&(oCostingSheetOverheadRow.PLANT_ID!=="")){
			// checkPlant
			const aFieldsMainPlcTable = ["PLANT_ID"];//name in t_overhead_group
			const aKeyFieldsRefObjectPlcTable = ["PLANT_ID"];//name in t_plant 
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.ACTIVITY_TYPE_ID))&&(oCostingSheetOverheadRow.ACTIVITY_TYPE_ID!=="")){
			// check ActivityTypeId
			const aFieldsMainPlcTable = ["ACTIVITY_TYPE_ID", "CONTROLLING_AREA_ID"];//name in t_activity_type
			const aKeyFieldsRefObjectPlcTable = ["ACTIVITY_TYPE_ID", "CONTROLLING_AREA_ID"];//name in t_costing_sheet_overhead_row  
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.COST_CENTER_ID))&&(oCostingSheetOverheadRow.COST_CENTER_ID!=="")){
			// check CostCenterId
			const aFieldsMainPlcTable = ["COST_CENTER_ID", "CONTROLLING_AREA_ID"];//name in t_cost_center
			const aKeyFieldsRefObjectPlcTable = ["COST_CENTER_ID", "CONTROLLING_AREA_ID"];//name in t_costing_sheet_overhead_row  
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
		...
		if((!helpers.isNullOrUndefined(oCostingSheetOverheadRow.WORK_CENTER_ID))&&(oCostingSheetOverheadRow.WORK_CENTER_ID!=="")){
			// check WorkCenterId
			const aFieldsMainPlcTable = ["WORK_CENTER_ID", "PLANT_ID"];//name in t_work_center
			const aKeyFieldsRefObjectPlcTable = ["WORK_CENTER_ID", "PLANT_ID"];//name in t_costing_sheet_overhead_row  
			const aFieldsValuesMainPlcTable = apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
	 ...
	 * @param   {string} sMasterDataDate  - master data timestamp
	 */
	this.checkReferenceObjectsCostingSheetBase = function(oCostingSheetRow, sMasterDataDate) {
	 ...
	 * @param   {string} sMasterDataDate  - master data timestamp
	 */
	this.checkReferenceObjectsCostingSheetOverhead = function(oCostingSheetRow, sMasterDataDate) {
		...
		var oConfigurationOverhead = {
				sObjectName                       : sCostingSheetOverhead,
				aPartialKeyPlcTableColumns        : ["COSTING_SHEET_OVERHEAD_ID"],
				aOtherNonTemporaryPlcTableColumns : ["CREDIT_ACCOUNT_ID", "CONTROLLING_AREA_ID"]
		};
		
		var oConfigurationAccount = {
		        sObjectName                : sAccount,
		        aPartialKeyPlcTableColumns: ["ACCOUNT_ID", "CONTROLLING_AREA_ID"]
		};
	 ...
	 * @param   {string} sMasterDataDate  - master data timestamp
	 */
	this.checkReferenceObjectsAccountGroup = function(oCostingSheetRow, sMasterDataDate) {
    ...
    /**
	 * gets controlling area from costing sheet.
     * Controlling Area is used for validation of credit account id because it is primary key in t_account
	 *
	 * @param   {objects} oBatchItems - object containing an array of costing sheet rows + an array of costing sheet rows
	 * @returns {object}  oRecord     - entry being processed
	 */
	function getControllingAreaId(oBatchItems, oRecord, sMasterDataDate){
	...
	/**
	 * Helper function to check if the distribution of IS_RELEVANT_FOR_TOTAL flags is valid 
	 *
	 * @param aCostingSheetRowsResults - items containing the IS_RELEVANT_FOR_TOTAL flags
	 * @param aCostingSheetRowDependencies - dependencies of the newly inserted or updated rows
	 */
	function checkTotalFlagsForDependencies(aCostingSheetRowsResults, aCostingSheetRowDependencies){
		...
		aCostingSheetRowDependencies.forEach(oDependecy => {
			...
			if((iSourceMask & iTargetMask) !== iSourceMask){
				...
				oMessageDetails.validationObj = {"columnIds":oColumnsIds, "validationInfoCode": ValidationInfoCode.VALUE_ERROR};
	...
	/**
	 * Check if the IS_RELEVANT_FOR_TOTAL distribution is valid for all the referenced fields for sum rows
	 * The are 2 cases when the distribution could become invalid:
	 * 1) If a new dependency is added/updated and the source row have more IS_RELEVANT_FOR_TOTAL flags enabled that the target row
	 * 2) If one of the rows is disabling the IS_RELEVANT_FOR_TOTAL flags causing other dependencies to become inconsistent. Ex: intially,
	 *  both source and target rows have all IS_RELEVANT_FOR_TOTAL flags as 1. Then the source row disables them all => target row is now inconsistent
	 * 
	 * @param oBatchItemsInsert - entities to be inserted
	 * @param oBatchItemsUpdate - entities to be updated
	 * @param sMasterDataDate 
	 */
	function checkIfRowDependenciesHaveValidTotalFields(oBatchItemsInsert, oBatchItemsUpdate, sMasterDataDate, oResult){
		...
		if(aCostingSheetRowDependencies.length){
			var sInClause = aCostingSheetRowDependencies
								.map(oDependecy => `('${oDependecy.COSTING_SHEET_ID}','${oDependecy.SOURCE_ROW_ID}'),('${oDependecy.COSTING_SHEET_ID}','${oDependecy.TARGET_ROW_ID}')`)
								.join(",");
			var sStmt = `
		...
		if(!helpers.isNullOrUndefined(oBatchItemsUpdate) && !helpers.isNullOrUndefined(oBatchItemsUpdate.COSTING_SHEET_ROW_ENTITIES)){
			...
			var sInClause = oBatchItemsUpdate.COSTING_SHEET_ROW_ENTITIES
								.map(row => `('${row.COSTING_SHEET_ID}','${row.COSTING_SHEET_ROW_ID}')`)
								.join(",");
			...
			if(sInClauseDependecies !== ''){ //at least one depedency retrieved from the db
				var sStmtRows = `
					SELECT COSTING_SHEET_ID, COSTING_SHEET_ROW_ID, IS_RELEVANT_FOR_TOTAL, IS_RELEVANT_FOR_TOTAL2, IS_RELEVANT_FOR_TOTAL3
					FROM "${Tables.costing_sheet_row}"
	...
	/** Function used to check if the rows inserted/updated are still valid
	 *  A row becomes invalid in 2 cases:
	 *  1) The row have more IS_RELEVANT_FOR_TOTAL flags enabled than the associated costing sheet
	 *  2) One of the dependencies containing the row inserted/updated is no longer valid
	 * 
	 * @param oBatchItemsInsert - entites that was inserted
	 * @param oBatchItemsUpdate - entites that were updated
	 * @param sMasterDataDate  
	 */
	
	this.checkIfTotalFieldsAreValidForCostingSheetRows = function(oBatchItemsInsert, oBatchItemsUpdate, sMasterDataDate){
		
		var oResult = initResults();
		checkIfRowDependenciesHaveValidTotalFields(oBatchItemsInsert, oBatchItemsUpdate, sMasterDataDate, oResult);
	 ...
	 *
	 * @param   {objects} oBatchItems - object containing an array of costing sheet rows + an array of costing sheet rows texts
	...
	this.insert = function(oBatchItems, sMasterDataDate){
		...
		_.each(aCostingSheetOverheadItems, function(oRecord){ 
			try {
			    if(!helpers.isNullOrUndefined(oRecord.CREDIT_ACCOUNT_ID)){
			        oRecord = getControllingAreaId(oBatchItems, oRecord, sMasterDataDate);
			    }
		...
		_.each(aCostingSheetOverheadRowItems, function(oRecord){ 
			try {
				...
				let oResultInsert = that.insertCostingSheetOverheadRowRow(_.omit(oRecord, ["FORMULA_STRING", "FORMULA_DESCRIPTION","OVERHEAD_CUSTOM"]), sMasterDataDate);
	 ...
	 * Insert row
	 *
	 * @param {object} oCostingSheetOverheadRow - insert entry
	 *        E.g: {,
                         "COSTING_SHEET_ROW_ID": "MEK",
                         "COSTING_SHEET_ID": "COGS",
                         "_VALID_FROM": "2015-03-25T11:13:58.315Z"
	 ...
	 * @param   {string} sMasterDataDate  - master data timestamp
	 * @returns {object} oResult          - created entry
	 */
	this.insertCostingSheetOverheadRowRow = function(oCostingSheetOverheadRow, sMasterDataDate){
	...
	/**
	 * This method checks if the custom field that is used as an overhead custom is of the corresponding type
	 * @param oRecord - the costing sheet overhead row record that contains the overhead custom
	 */
	...
	/**
	 * Insert costing sheet overhead row formula
	 *
	 * @param {object} oCostingSheetOverheadRowFormula - insert entry
	 * @returns {object} oResult          - created entry
	 */
	this.insertCostingSheetOverheadRowFormula = function(oCostingSheetOverheadRowFormula){
		...
		dbConnection.executeUpdate(sStmt, oCostingSheetOverheadRowFormula.FORMULA_ID,
												 oCostingSheetOverheadRowFormula.FORMULA_STRING,
												 oCostingSheetOverheadRowFormula.FORMULA_DESCRIPTION,
												 oCostingSheetOverheadRowFormula.OVERHEAD_CUSTOM);
	};

	/**
	 * Update costing sheet overhead row formula
	 *
	 * @param {object} oCostingSheetOverheadRowFormula - update entry
	...
	this.updateCostingSheetOverheadRowFormula = function(oCostingSheetOverheadRowFormula){
		...
		dbConnection.executeUpdate(sStmt, oCostingSheetOverheadRowFormula.FORMULA_DESCRIPTION,
												 oCostingSheetOverheadRowFormula.FORMULA_STRING,
												 oCostingSheetOverheadRowFormula.OVERHEAD_CUSTOM,
												 oCostingSheetOverheadRowFormula.FORMULA_ID);
	};

	/**
	 * Delete costing sheet overhead row formula
	 *
	 * @param {object} oCostingSheetOverheadRow - delete entry
	 * @returns {object} oResult          - deleted entry
	 */
	 ...
	 * Delete costing sheet overhead row formula
	 *
	 * @param {object} iCostingSheetOverheadId - delete entry
	 * @returns {object} oResult          - deleted entry
	 */
	...
	/**
	 * Get costing sheet overhead row formula id
	 *
	 * @param {object} oCostingSheetOverheadRow - overhead row entry
	 * @returns {object} oResult          - formula id
	 */
	this.getCostingSheetOverheadRowFormulaId = function(oCostingSheetOverheadRow){
		...
		const sCostingSheetOverheadRowStmt =
			`SELECT FORMULA_ID FROM "${sCostingSheetOverheadRowTableName}"  WHERE
			 _VALID_TO IS NULL AND
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.insertCostingSheetOverheadRow = function(oCostingSheetOverhead, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.insertCostingSheetBaseRowRow = function(oCostingSheetBaseRow, sMasterDataDate){

		var oConfiguration = {
				sObjectName                : sCostingSheetBaseRow,
				aPartialKeyPlcTableColumns : ["COSTING_SHEET_BASE_ID", "ITEM_CATEGORY_ID", "CHILD_ITEM_CATEGORY_ID"]
		};
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.insertCostingSheetBaseRow = function(oCostingSheetBase, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - deleted entry
	 */
	this.insertCostingSheetRowRow = function(oCostingSheetRow, sMasterDataDate){
		...
		// the row type is determied based on the attribute that is filled
		//only 1 of the 3 ( COSTING_SHEET_BASE_ID, ACCOUNT_GROUP_AS_BASE_ID, COSTING_SHEET_OVERHEAD_ID) should be filled 
		if((oCostingSheetRow.COSTING_SHEET_BASE_ID !== undefined && oCostingSheetRow.COSTING_SHEET_OVERHEAD_ID !== undefined) 
				|| (oCostingSheetRow.COSTING_SHEET_OVERHEAD_ID !== undefined && oCostingSheetRow.ACCOUNT_GROUP_AS_BASE_ID !== undefined) 
				|| (oCostingSheetRow.COSTING_SHEET_BASE_ID !== undefined && oCostingSheetRow.ACCOUNT_GROUP_AS_BASE_ID !== undefined)){
	 ...
	 */
	this.insertCostingSheetRowTextRow = function(oCostingSheetRowTextRow, sMasterDataDate){
	 ...
	 * @returns {object} oResult          - inserted entry
	 */
	this.insertCostingSheetRowDependenciesRow = function(oCostingSheetDependencies,sMasterDataDate){
	...
	/**
	 * inits an object that will contain the operations results for CostingSheetRow
	 */
