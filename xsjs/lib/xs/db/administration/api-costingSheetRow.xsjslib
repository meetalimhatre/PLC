...
async function CostingSheetRow(dbConnection, hQuery, hQueryRepl) {
    ...
    this.remove = async function (oBatchItems, sMasterDataDate) {
        ...
        _.each(aCostingSheetOverheadRowItems, async function (oRecord) {
            try {
                ...
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_OVERHEAD_ROW_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
        ...
        _.each(aCostingSheetOverheadItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_OVERHEAD_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
        ...
        _.each(aCostingSheetRowBaseRowItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_BASE_ROW_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
        ...
        _.each(aCostingSheetRowBaseItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_BASE_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
        ...
        _.each(aBatchMainItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
        ...
        _.each(aBatchMainTextItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_TEXT_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
        ...
        _.each(aBatchDependenciesItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_DEPENDENCIES_ENTITIES, e, MessageOperation.DELETE, oResult);
            }
        });
    ...
    this.removeCostingSheetOverheadRow = async function (oCostingSheetOverhead, sMasterDataDate) {
        ...
        oResult = await apiHelpers.removeRow(oCostingSheetOverhead, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.removeCostingSheetOverheadRowRow = async function (oCostingSheetOverheadRow, sMasterDataDate) {
        ...
        return await apiHelpers.removeRow(oCostingSheetOverheadRow, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.removeCostingSheetBaseRowRow = async function (oCostingSheetBaseRow, sMasterDataDate) {
        ...
        return await apiHelpers.removeRow(oCostingSheetBaseRow, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.removeCostingSheetBaseRow = async function (oCostingSheetBase, sMasterDataDate) {
        ...
        oResult = await apiHelpers.removeRow(oCostingSheetBase, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.removeCostingSheetTextRowRow = async function (oCostingSheetRowText, sMasterDataDate) {
        ...
        return await apiHelpers.removeTextRow(oCostingSheetRowText, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.removeCostingSheetRowRow = async function (oCostingSheetRow, sMasterDataDate) {
        ...
        var oResult = [];
        var aFieldsValuesCostingSheetRowTable = await apiHelpers.getColumnKeyValues(oConfiguration.aPartialKeyPlcTableColumns, oCostingSheetRow);
        ...
        oResult = await apiHelpers.removeRow(oCostingSheetRow, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.removeCostingSheetRowDependencies = async function (oCostingSheetDependencies, sMasterDataDate) {
        ...
        return await apiHelpers.removeRow(oCostingSheetDependencies, sMasterDataDate, oConfiguration, hQuery);
    ...
    this.update = async function (oBatchItems, sMasterDataDate) {
        ...
        _.each(aCostingSheetOverheadRowItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_OVERHEAD_ROW_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
        ...
        _.each(aCostingSheetOverheadItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_OVERHEAD_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
        ...
        _.each(aCostingSheetRowBaseRowItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_BASE_ROW_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
        ...
        _.each(aCostingSheetRowBaseItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_BASE_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
        ...
        _.each(aBatchMainItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
        ...
        _.each(aBatchTextItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_TEXT_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
        ...
        _.each(aBatchDepItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_DEPENDENCIES_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        });
...
//Base as Account Group
    ...
    this.checkReferenceObjectsCostingSheetOverheadRow = async function (oCostingSheetOverheadRow, sMasterDataDate) {
        ...
        if (!helpers.isNullOrUndefined(oCostingSheetOverheadRow.CONTROLLING_AREA_ID) && oCostingSheetOverheadRow.CONTROLLING_AREA_ID !== '') {
            ...
            const aFieldsValuesMainPlcTable = await apiHelpers.getColumnKeyValues(aFieldsMainPlcTable, oCostingSheetOverheadRow);
    ...
    this.checkReferenceObjectsCostingSheetBase = async function (oCostingSheetRow, sMasterDataDate) {
        ...
        if (!helpers.isNullOrUndefined(oCostingSheetRow.COSTING_SHEET_BASE_ID)) {
            var aFieldsValuesCostingSheetBasePlcTable = await apiHelpers.getColumnKeyValues(oConfigurationBase.aPartialKeyPlcTableColumns, oCostingSheetRow);
    ...
    this.checkReferenceObjectsCostingSheetOverhead = async function (oCostingSheetRow, sMasterDataDate) {
        ...
        if (!helpers.isNullOrUndefined(oCostingSheetRow.COSTING_SHEET_OVERHEAD_ID)) {
            aFieldsValuesCostingSheetOverheadPlcTable = await apiHelpers.getColumnKeyValues(oConfigurationOverhead.aPartialKeyPlcTableColumns, oCostingSheetRow);
        ...
        if (!helpers.isNullOrUndefined(oCostingSheetRow.CREDIT_ACCOUNT_ID)) {
            aFieldsValuesCostingSheetOverheadPlcTable = await apiHelpers.getColumnKeyValues(oConfigurationOverhead.aOtherNonTemporaryPlcTableColumns, oCostingSheetRow);
    ...
    this.checkReferenceObjectsAccountGroup = async function (oCostingSheetRow, sMasterDataDate) {
        ...
        if (!helpers.isNullOrUndefined(oCostingSheetRow.ACCOUNT_GROUP_AS_BASE_ID)) {
            var aFieldsValuesCostingSheetAccountGroupPlcTable = await apiHelpers.getColumnKeyValues(oConfiguration.aPartialKeyPlcTableColumns, oCostingSheetRow);
    ...
    async function checkIfRowDependenciesHaveValidTotalFields(oBatchItemsInsert, oBatchItemsUpdate, sMasterDataDate, oResult) {
        ...
        if (aCostingSheetRowDependencies.length) {
            ...
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(e.details.record, BusinessObjectsEntities.COSTING_SHEET_ROW_ENTITIES, e, MessageOperation.UPDATE, oResult);
            }
        }
    ...
    this.insert = async function (oBatchItems, sMasterDataDate) {
        ...
        _.each(aCostingSheetOverheadItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_OVERHEAD_ENTITIES, e, MessageOperation.CREATE, oResult);
            }
        });
        ...
        _.each(aCostingSheetOverheadRowItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_OVERHEAD_ROW_ENTITIES, e, MessageOperation.CREATE, oResult);
            }
        });
        ...
        _.each(aCostingSheetRowBaseRowItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_BASE_ROW_ENTITIES, e, MessageOperation.CREATE, oResult);
            }
        });
        ...
        _.each(aBatchMainItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_ENTITIES, e, MessageOperation.CREATE, oResult);
            }
        });
        ...
        _.each(aBatchTextItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_TEXT_ENTITIES, e, MessageOperation.CREATE, oResult);
            }
        });
        ...
        _.each(aBatchDepItems, async function (oRecord) {
            try {
                ...
                oResult.hasErrors = true;
                await apiHelpers.createResponse(oRecord, BusinessObjectsEntities.COSTING_SHEET_ROW_DEPENDENCIES_ENTITIES, e, MessageOperation.CREATE, oResult);
            }
        });
    ...
    this.insertCostingSheetOverheadRowRow = async function (oCostingSheetOverheadRow, sMasterDataDate) {
        ...
        await apiHelpers.checkMandatoryProperties(oCostingSheetOverheadRow, aPartialKeyPlcTableColumns);
    ...
    this.insertCostingSheetOverheadRow = async function (oCostingSheetOverhead, sMasterDataDate) {
        ...
        var aPartialKeyPlcTableColumns = oConfiguration.aPartialKeyPlcTableColumns;
        var aPartialKeyPlcTableColumnValues = await apiHelpers.getColumnKeyValues(aPartialKeyPlcTableColumns, oCostingSheetOverhead);


        await apiHelpers.checkMandatoryProperties(oCostingSheetOverhead, aPartialKeyPlcTableColumns);
    ...
    this.insertCostingSheetBaseRowRow = async function (oCostingSheetBaseRow, sMasterDataDate) {
        ...
        var aPartialKeyPlcTableColumns = oConfiguration.aPartialKeyPlcTableColumns;
        var aPartialKeyPlcTableColumnValues = await apiHelpers.getColumnKeyValues(aPartialKeyPlcTableColumns, oCostingSheetBaseRow);

        const oValidItemCategoryIds = await that.getItemCategories();


        await apiHelpers.checkMandatoryProperties(oCostingSheetBaseRow, aPartialKeyPlcTableColumns);


        var iCategoryId = _.has(oCostingSheetBaseRow, 'ITEM_CATEGORY_ID') ? await genericSyntaxValidator.validateValue(oCostingSheetBaseRow.ITEM_CATEGORY_ID, 'PositiveInteger', undefined, true) : null;
        var iChildCategoryId = _.has(oCostingSheetBaseRow, 'CHILD_ITEM_CATEGORY_ID') ? await genericSyntaxValidator.validateValue(oCostingSheetBaseRow.CHILD_ITEM_CATEGORY_ID, 'PositiveInteger', undefined, true) : null;
    ...
    this.insertCostingSheetBaseRow = async function (oCostingSheetBase, sMasterDataDate) {
        ...
        var aPartialKeyPlcTableColumns = oConfiguration.aPartialKeyPlcTableColumns;
        var aPartialKeyPlcTableColumnValues = await apiHelpers.getColumnKeyValues(aPartialKeyPlcTableColumns, oCostingSheetBase);


        await apiHelpers.checkMandatoryProperties(oCostingSheetBase, aPartialKeyPlcTableColumns);
    ...
    this.insertCostingSheetRowDependenciesRow = async function (oCostingSheetDependencies, sMasterDataDate) {
        ...
        var aFoundCostingSheetRecords = await apiHelpers.findValidEntriesInTable(Resources[sCostingSheet].dbobjects.plcTable, [oConfiguration.aPartialKeyPlcTableColumns[2]], [oCostingSheetDependencies.COSTING_SHEET_ID], sMasterDataDate, hQuery);
