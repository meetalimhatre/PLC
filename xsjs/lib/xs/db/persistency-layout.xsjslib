...
function Layout(dbConnection, hQuery) {
	 ...
	 *
	 */
    this.getLayouts = async function (sUserId, iLayoutType) {
	 ...
	 *            iLayoutId - layout id
	 */
    this.createLayoutAdditionalData = async function (oLayoutData, iLayoutId) {
	 ...
	 * @returns {boolean} - true if the layout id exists, otherwise false
	 */
    this.isNameUnique = async function (iLayoutId, sLayoutName, sUserId) {
	 ...
	 *            iLayoutId - the layout id
	 */
    this.deleteLayoutAdditionalData = async function (iLayoutId) {
