...
this.init = function(oBodyData, aParameters, oServiceOutput, oPersistency) {
		...
		var oBasicData = getBasicData(aLanguages, sIsoLanguage, sClientId, oPersistency);
	 ...
	 */
	function getBasicData(aLanguages, sIsoLanguage, sClientId, oPersistency) {
        var sUserId = $.getPlcUsername();
		var sSessionId = $.getPlcUsername();
	 ...
	 */
	function getCurrency(sIsoLanguage, oPersistency) {
	 ...
	 */
	function getUnitOfMeasures(sIsoLanguage, oPersistency) {
...
}; // end of module.exports.InitSession