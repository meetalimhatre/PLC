...
this.edit = function(oBodyItems, aParameters, oServiceOutput, oPersistency) {
	...
	createPrivileges(oBodyItems, oPersistency, aResultErrors);
	deletePrivileges(oBodyItems, oPersistency, aResultErrors);
	updatePrivileges(oBodyItems, oPersistency, aResultErrors);
...
function createPrivileges(oBodyItems, oPersistency, aResultErrors) {
...
function deletePrivileges(oBodyItems, oPersistency, aResultErrors) {
...
function updatePrivileges(oBodyItems, oPersistency, aResultErrors) {
...
}; // end of module.exports.Privileges