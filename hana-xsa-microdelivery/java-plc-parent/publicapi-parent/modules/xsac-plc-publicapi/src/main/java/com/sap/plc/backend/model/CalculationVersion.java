...
import static com.sap.plc.backend.model.CalculationVersion.TABLE_NAME;

@IdClass(CalculationVersionPrimaryKey.class)
@Table(name = TABLE_NAME)
@Entity
public class CalculationVersion extends com.sap.plc.backend.model.Entity<CalculationVersion,
        CalculationVersionPrimaryKey> {

    private static final long serialVersionUID = 552056964914073272L;

    static final String TABLE_NAME = "`sap.plc.db::basis.t_calculation_version`";
    public static final String TABLE_NAME_DOUBLE_QUOTES = "\"sap.plc.db::basis.t_calculation_version\"";
    public static final String TEMPORARY_TABLE_NAME_DOUBLE_QUOTES =
            "\"sap.plc.db::basis.t_calculation_version_temporary\"";
    ...
    public boolean equals(Object o) {
        ...
        CalculationVersion that = (CalculationVersion) o;
